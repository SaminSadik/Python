        ...
        if c == '1':
            ...
            if amount.isnumeric() and (int(amount) != 0):
                ...
                if(caller.Loaned > 0):
                    ...
                    if(will_pay == 'yes'):
                        caller.pay_loan(min(amount, caller.Loaned))
                        amount = max(0, (amount - caller.Loaned))
                if(amount>0):
