...
class Admin:
    ...
    def toggle_loan(self):
        Bank.Loanability(not Bank.Loanability())
        if(Bank.Loanability() is True): print("Loans Turned ON: _users can take loans now")
